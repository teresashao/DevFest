...
function Entry({ sendDataToParent, sendSubmit, submit }) {
    const style1={
      color: 'transparent', 
    ...
    <div> 
       <div className="flex flex-col h-min-full justify-center items-center">
        <div className="flex justify-center align-center mt-8">
          ...
          <textarea
              value={journalText}
              className=" flex font-mont w-full h-96 p-2 opacity-50 border border-gray-300 rounded focus:outline-none focus:border-blue-500 text-sm text-black"
